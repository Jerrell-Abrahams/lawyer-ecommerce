...
export default function AboutPage() {
    return (
        <div>
            ...
            <Hero
                title="Supporting Mobility, One Step at a Time"
                subtitle="We provide high-quality orthopedic prosthetics designed to give animals the freedom to move again."
            />
