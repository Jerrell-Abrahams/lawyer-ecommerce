...
const Details = () => (
    <>
        <div className="max-w-5xl mx-auto px-5 py-8 md:py-16">
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
                <div className="md:w-1/2 h-56 md:h-64 flex items-center">
                    <div>
                        <h3 className="text-2xl md:text-3xl font-semibold text-neutral-800 mb-4">
        ...
        <div className="max-w-5xl mx-auto px-5 py-6 md:py-16">
            <div className="flex flex-col md:flex-row-reverse items-center gap-6 md:gap-12">
                <div className="md:w-1/2 h-56 md:h-64 flex items-center">
                    <div>
                        ...
                        <p className="md:text-lg text-gray-700 leading-relaxed">
                            Our  team  collaborates  with  veterinarians  to  design  bespoke orthopaedic components  and  case-specific instruments —ensuring optimal fit, function, and patient outcomes.
                        </p>
                    </div>
                </div>
                <div className="md:w-1/2 w-full">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
                <div className="md:w-1/2 h-56 md:h-64 flex items-center">
                    <div>
                        ...
                        <p className="md:text-lg text-gray-700 leading-relaxed">
                            Animal Ortho Solutions ensures consistent availability of essential products, prompt delivery, and responsive post-purchase support to keep your practice running smoothly.
                        </p>
                    </div>
                </div>
                <div className="md:w-1/2 w-full">
